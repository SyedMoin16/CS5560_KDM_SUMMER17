...
object SparkLDAMain {
  ...
  private def run(params: Params) {
    ...
    val topic_output = new PrintStream("C:\\Users\\syedm\\Desktop\\Tutorial 4 Source Code\\Tutorial 4 Source Code\\SparkOpenIE_WordNET_LDA\\data\\Results.txt")
    ...
    lda.setOptimizer(optimizer)
      .setK(params.k)  //setK is mandatory
      .setMaxIterations(50)
  ...
  private def preprocess(sc: SparkContext,paths: Seq[String]): (RDD[(Long, Vector)], Array[String], Long) = {
    ...
    //Reading Stop Words
    val stopWords=sc.textFile("C:\\Users\\syedm\\Desktop\\Tutorial 4 Source Code\\Tutorial 4 Source Code\\SparkOpenIE_WordNET_LDA\\data\\stopwords.txt").collect()
