...
object SparkKMeansMain {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val inputPath=Seq("C:\\Users\\syedm\\Desktop\\kdm\\datasets\\bbcsport\\*")

    //val inputPath= sc.textFile("C:\\Users\\syedm\\Desktop\\Yahoo-Question-testdata.csv").map(line=> line.split(",").map(_.trim))



    Logger.getRootLogger.setLevel(Level.WARN)

    val topic_output = new PrintStream("C:\\Users\\syedm\\Desktop\\CS5560 - Tutorial 5 Source\\Spark_MachineLearning\\data\\Results_KMeans.txt")
