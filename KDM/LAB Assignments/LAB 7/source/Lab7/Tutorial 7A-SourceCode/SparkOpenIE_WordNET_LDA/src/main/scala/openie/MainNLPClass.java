...
public class MainNLPClass {
    ...
    public static HashSet<String> stopWordRemoving(ArrayList arrayList) throws IOException {
        ...
        BufferedReader br = new BufferedReader(new FileReader("C:\\Users\\syedm\\Desktop\\Tutorial 7A-SourceCode\\Tutorial 7A-SourceCode\\SparkOpenIE_WordNET_LDA\\data\\stopwords.txt"));
    ...
    public static HashSet<String> getSynonyms(String word) {
        RiWordNet wordnet = new RiWordNet("C:\\Users\\syedm\\Desktop\\WordNet-3.0");
