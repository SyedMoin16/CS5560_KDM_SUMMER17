...
object OntContructorMain {
  def main(args: Array[String]): Unit = {
    ...
    val classes = Source.fromFile("C:\\Users\\syedm\\Desktop\\Tutorial 7A-SourceCode\\Tutorial 7A-SourceCode\\OntContructor\\data\\Classes").getLines()
    ...
    val objprop = Source.fromFile("C:\\Users\\syedm\\Desktop\\Tutorial 7A-SourceCode\\Tutorial 7A-SourceCode\\OntContructor\\data\\ObjectProperties").getLines()
    objprop.foreach(f => {
      val farr = f.split(",")
    ...
    val dataprop = Source.fromFile("C:\\Users\\syedm\\Desktop\\Tutorial 7A-SourceCode\\Tutorial 7A-SourceCode\\OntContructor\\data\\DataProperties").getLines()
    ...
    val individuals = Source.fromFile("C:\\Users\\syedm\\Desktop\\Tutorial 7A-SourceCode\\Tutorial 7A-SourceCode\\OntContructor\\data\\Individuals").getLines()
    ...
    val triplets = Source.fromFile("C:\\Users\\syedm\\Desktop\\Tutorial 7A-SourceCode\\Tutorial 7A-SourceCode\\OntContructor\\data\\Triplets").getLines()
    triplets.foreach(f => {
      val farr = f.split(",")
    ...
    val os = new FileOutputStream("C:\\Users\\syedm\\Desktop\\Tutorial 7A-SourceCode\\Tutorial 7A-SourceCode\\OntContructor\\data\\football.owl")
